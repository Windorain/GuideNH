...
public class Tokenizer {
    ...
    public class Effects {
        ...
        public Token enter(String type, Token fields) {
            ...
            context.getEvents()
                .add(new Event(EventType.ENTER, token, context));
    ...
    public Point now() {
        return new Point(pointLine, pointColumn, pointOffset, pointIndex, pointBufferIndex);
    }
    ...
    void main() {
        ...
        while (pointIndex < chunks.size()) {
            ...
            if (chunk instanceof String textChunk) {
                ...
                while (pointIndex == chunkIndex && pointBufferIndex < textChunk.length()) {
    ...
    private class HookStateMachineFactory {
        ...
        public State create(Construct construct) {
            return code -> {
                ...
                return currentConstruct.tokenize.tokenize(useContext, effects, this::ok, this::nok)
                    .step(code);
            };
        }
    ...
    Info store() {
        ...
        var startEventsIndex = context.getEvents()
            .size();
        ...
        while (++index < chunks.size()) {
            ...
            if (chunk instanceof String textChunk) {
                ...
                switch (code) {
                    ...
                    case Codes.carriageReturnLineFeed -> result.append('\r')
                        .append('\n');
